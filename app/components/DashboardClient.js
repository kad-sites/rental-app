    ...
    <>
      ...
      {showCashModal && (
        <div style={{
          ...
          <div className="glass-panel" style={{width: '100%', maxWidth: '400px', position: 'relative'}}>
            ...
            <h2 style={{color: '#fff', marginBottom: '1rem', paddingRight: '2rem'}}>Record Cash Entry</h2>

            <div style={{display: 'flex', gap: '10px', marginBottom: '1.5rem'}}>
              <button 
                type="button" 
                className={`btn ${cashModalMode === 'INVOICE' ? 'btn-success' : 'btn-outline'}`}
              ...
              <button 
                type="button" 
                className={`btn ${cashModalMode === 'DEPOSIT' ? 'btn-success' : 'btn-outline'}`}
                style={{flex: 1, padding: '0.5rem', fontSize: '0.85rem'}}
      ...
      <div className="dashboard-grid-app">
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', zIndex: 1, position: 'relative' }}>
              ...
              <tbody>
                {activeTenants.length === 0 ? (
                  ...
                  activeHouseNumbers.map(house => (
                    <Fragment key={house}>
                      <tr>
                        <td colSpan="5" style={{backgroundColor: 'transparent', border: 'none', padding: '1rem 0.5rem 0.25rem 0.5rem'}}>
                  ...
                  <tr key={inv.id}>
                    <td>
                      <div style={{display: 'flex', alignItems: 'center', gap: '6px'}}>
                        ...
                        {overdueCount > 0 && (
                          <svg 
                            className={overdueCount >= 3 ? 'overdue-alert-red' : overdueCount === 2 ? 'overdue-alert-orange' : 'overdue-alert-yellow'} 
                            width="14" height="14" viewBox="0 0 24 24" fill="currentColor"
                            style={{flexShrink: 0}}
                          >
                            <path d="M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z"/>
